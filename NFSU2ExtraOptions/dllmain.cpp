...
int hotkeyAnyTrackInAnyMode, hotkeyUnlockAllThings, hotkeyLANSwitcher, hotkeyToggleHeadLights, StartingCash, ReflectionResW, ReflectionResH, VehRefRes;
DWORD GameState;
HWND windowHandle;
...
void Init()
{
	...
	// Gameplay
	PS2LoadingTips = iniReader.ReadInteger("Gameplay", "PS2LoadingTips", 1) == 1;
	...
	// Use PS2 Loading Menu (very bad code)
	
	if (PS2LoadingTips)
	{
		// 'push' asm stuff

		injector::WriteMemory<unsigned char>(0x4A9310, 0x68, true);
		injector::WriteMemory<unsigned char>(0x4A9311, 0x44, true);
		injector::WriteMemory<unsigned char>(0x4A9312, 0x07, true);
		injector::WriteMemory<unsigned char>(0x4A9313, 0x79, true);
		injector::WriteMemory<unsigned char>(0x4A9314, 0x00, true);
		
		injector::WriteMemory<unsigned char>(0x4A9321, 0x68, true);
		injector::WriteMemory<unsigned char>(0x4A9322, 0x44, true);
		injector::WriteMemory<unsigned char>(0x4A9323, 0x07, true);
		injector::WriteMemory<unsigned char>(0x4A9324, 0x79, true);
		injector::WriteMemory<unsigned char>(0x4A9325, 0x00, true);

		injector::WriteMemory<unsigned char>(0x4A9330, 0x68, true);
		injector::WriteMemory<unsigned char>(0x4A9331, 0x44, true);
		injector::WriteMemory<unsigned char>(0x4A9332, 0x07, true);
		injector::WriteMemory<unsigned char>(0x4A9333, 0x79, true);
		injector::WriteMemory<unsigned char>(0x4A9334, 0x00, true);

		injector::WriteMemory<unsigned char>(0x4A9340, 0x68, true);
		injector::WriteMemory<unsigned char>(0x4A9341, 0x44, true);
		injector::WriteMemory<unsigned char>(0x4A9342, 0x07, true);
		injector::WriteMemory<unsigned char>(0x4A9343, 0x79, true);
		injector::WriteMemory<unsigned char>(0x4A9344, 0x00, true);

		injector::WriteMemory<unsigned char>(0x4C57C0, 0x68, true);
		injector::WriteMemory<unsigned char>(0x4C57C1, 0x44, true);
		injector::WriteMemory<unsigned char>(0x4C57C2, 0x07, true);
		injector::WriteMemory<unsigned char>(0x4C57C3, 0x79, true);
		injector::WriteMemory<unsigned char>(0x4C57C4, 0x00, true);

		injector::WriteMemory<unsigned char>(0x4C57D3, 0x68, true);
		injector::WriteMemory<unsigned char>(0x4C57D4, 0x44, true);
		injector::WriteMemory<unsigned char>(0x4C57D5, 0x07, true);
		injector::WriteMemory<unsigned char>(0x4C57D6, 0x79, true);
		injector::WriteMemory<unsigned char>(0x4C57D7, 0x00, true);

		injector::WriteMemory<unsigned char>(0x55B14F, 0x68, true);
		injector::WriteMemory<unsigned char>(0x55B150, 0x44, true);
		injector::WriteMemory<unsigned char>(0x55B151, 0x07, true);
		injector::WriteMemory<unsigned char>(0x55B152, 0x79, true);
		injector::WriteMemory<unsigned char>(0x55B153, 0x00, true);

		injector::WriteMemory<unsigned char>(0x55B17F, 0x68, true);
		injector::WriteMemory<unsigned char>(0x55B180, 0x44, true);
		injector::WriteMemory<unsigned char>(0x55B181, 0x07, true);
		injector::WriteMemory<unsigned char>(0x55B182, 0x79, true);
		injector::WriteMemory<unsigned char>(0x55B183, 0x00, true);

		injector::WriteMemory<unsigned char>(0x57FC30, 0x68, true);
		injector::WriteMemory<unsigned char>(0x57FC31, 0x44, true);
		injector::WriteMemory<unsigned char>(0x57FC32, 0x07, true);
		injector::WriteMemory<unsigned char>(0x57FC33, 0x79, true);
		injector::WriteMemory<unsigned char>(0x57FC34, 0x00, true);

		injector::WriteMemory<unsigned char>(0x57FC3C, 0x68, true);
		injector::WriteMemory<unsigned char>(0x57FC3D, 0x44, true);
		injector::WriteMemory<unsigned char>(0x57FC3E, 0x07, true);
		injector::WriteMemory<unsigned char>(0x57FC3F, 0x79, true);
		injector::WriteMemory<unsigned char>(0x57FC40, 0x00, true);

		injector::WriteMemory<unsigned char>(0x57FF85, 0x68, true);
		injector::WriteMemory<unsigned char>(0x57FF86, 0x44, true);
		injector::WriteMemory<unsigned char>(0x57FF87, 0x07, true);
		injector::WriteMemory<unsigned char>(0x57FF88, 0x79, true);
		injector::WriteMemory<unsigned char>(0x57FF89, 0x00, true);

		injector::WriteMemory<unsigned char>(0x57FF98, 0x68, true);
		injector::WriteMemory<unsigned char>(0x57FF99, 0x44, true);
		injector::WriteMemory<unsigned char>(0x57FF9A, 0x07, true);
		injector::WriteMemory<unsigned char>(0x57FF9B, 0x79, true);
		injector::WriteMemory<unsigned char>(0x57FF9C, 0x00, true);	

		injector::WriteMemory<unsigned char>(0x5EB830, 0x68, true);
		injector::WriteMemory<unsigned char>(0x5EB831, 0x44, true);
		injector::WriteMemory<unsigned char>(0x5EB832, 0x07, true);
		injector::WriteMemory<unsigned char>(0x5EB833, 0x79, true);
		injector::WriteMemory<unsigned char>(0x5EB834, 0x00, true);

		injector::WriteMemory<unsigned char>(0x603925, 0x68, true);
		injector::WriteMemory<unsigned char>(0x603926, 0x44, true);
		injector::WriteMemory<unsigned char>(0x603927, 0x07, true);
		injector::WriteMemory<unsigned char>(0x603928, 0x79, true);
		injector::WriteMemory<unsigned char>(0x603929, 0x00, true);

		injector::WriteMemory<unsigned char>(0x603959, 0x68, true);
		injector::WriteMemory<unsigned char>(0x60395A, 0x44, true);
		injector::WriteMemory<unsigned char>(0x60395B, 0x07, true);
		injector::WriteMemory<unsigned char>(0x60395C, 0x79, true);
		injector::WriteMemory<unsigned char>(0x60395D, 0x00, true);

		injector::WriteMemory<unsigned char>(0x603996, 0x68, true);
		injector::WriteMemory<unsigned char>(0x603997, 0x44, true);
		injector::WriteMemory<unsigned char>(0x603998, 0x07, true);
		injector::WriteMemory<unsigned char>(0x603999, 0x79, true);
		injector::WriteMemory<unsigned char>(0x60399A, 0x00, true);
		
		// 'and' asm stuff 

		injector::WriteMemory<unsigned char>(0x4A9351, 0x25, true);
		injector::WriteMemory<unsigned char>(0x4A9352, 0x44, true);
		injector::WriteMemory<unsigned char>(0x4A9353, 0x07, true);
		injector::WriteMemory<unsigned char>(0x4A9354, 0x79, true);
		injector::WriteMemory<unsigned char>(0x4A9355, 0x00, true);	
	}
